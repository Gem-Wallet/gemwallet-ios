#
#  Be sure to run `pod spec lint GemWalletENS.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  spec.name         = "GemWalletENS"
  spec.version      = "1.0.0"
  spec.summary      = "GemWallet ENS functionality"
  ...
  spec.homepage     = "https://github.com/Gem-Wallet/gemwallet-ios/tree/master/modules/GemWalletENS"
  spec.ios.deployment_target = '13.0'
  spec.swift_version    = '4.0'
  spec.platform         = :ios, "13.0"
  spec.source           = { :git => 'git@github.com:GemWallet/gem-wallet-ios.git', :tag => "#{spec.version}" }
  spec.source_files     = 'modules/GemWalletENS/GemWalletENS/**/*.{h,m,swift}'
